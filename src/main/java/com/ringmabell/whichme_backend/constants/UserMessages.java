...
public class UserMessages {
    ...
    public static final String AVAILABLE_USERNAME = "사용가능한 아이디입니다";
    public static final String AVAILABLE_EMAIL = "사용가능한 이메일입니다";
    public static final String COMPLETE_JOIN = "회원가입이 완료되었습니다";
    public static final String COMPLETE_LOGIN = "로그인 성공";
 }
