...
import static com.ringmabell.whichme_backend.constants.DispatchMessage.ALREADY_EXIST_VEHICLE;
import static com.ringmabell.whichme_backend.constants.DispatchMessage.COMPLETE_VEHICLE_JOIN;
import static com.ringmabell.whichme_backend.constants.DispatchMessage.NOT_EXIST_SUBUNIT;
...
public class DispatchServiceImpl implements DispatchService {
    ...
    public Response joinDispatch(DispatchJoinDto dispatchJoinDto) {
        ...
        Dispatch dispatch = Dispatch.builder()
                ...
                .vehicleType(dispatchJoinDto.getVehicleType())
                .build();
